    ...
    <div className="max-w-screen-2xl container mx-auto xl:px-24 x-4 md:py-20 py-14">
      ...
      <form>
        <div className="flex justify-start md:flex-row flex-col md:gap-0 gap-4">
          ...
          <div className="flex md:rounded-s-none rounded shadow-sm ring-inset focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full">
            <input
              type="text"
              name="title"
